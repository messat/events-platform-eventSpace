...
export default function EventInfoLoadingScreen() {
    return (<Box aria-busy="true" role="status">
        ...
        <Skeleton variant="rounded" sx={{
            ...
            height: 500,
            width: 1300,
            mt: 3, borderRadius: "15px"}} aria-hidden="true">
        </Skeleton>
        </Box>
        ...
        <Box>
            <Container maxWidth='lg'>
                ...
                <Grid2 size={{ xs: 12, sm: 6, md: 7 }} sx={{my: 3}}>
                    <Skeleton  variant="text" sx={{p: 5}} aria-hidden="true"/>
                    <Skeleton width={"60%"} variant="text" sx={{p: 2}} aria-hidden="true"/>
                    <Box sx={{display: "flex", flexDirection: "row"}}>
                    <Skeleton variant="circular" width={40} height={40} sx={{mt: 2, mr: 2}} aria-hidden="true"/>
                    <Skeleton variant="text" width={"30%"} sx={{mt: 1.5}} aria-hidden="true"/>
                    </Box>
                    ...
                    <Skeleton width={"60%"} variant="text" sx={{p: 2}} aria-hidden="true"/>
                    <Skeleton width={"100%"} variant="text" sx={{p: 20, mt: -6}} aria-hidden="true"/>
                </Grid2>
                
                <Grid2 size={{ xs: 12, sm: 6, md: 5 }} sx={{mt: {xs: -14, sm: -4, md: -4}}}>
                    <Skeleton sx={{  mb: 3, width: {xs: 400, sm: 350, md: 400}, minWidth: 200, 
                    height: 350,
                    borderRadius: 1,}} aria-hidden="true"/>
                    <Skeleton variant="rectangular" width={"80%"} sx={{p: 15, mt: {xs: -4, sm: -4, md: -4}}} aria-hidden="true"/>
                </Grid2>
                </Grid2>
            </Container>
        </Box>
...
export function SignUpTicketLoading({eventByID}) {
    return (<Box sx={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "75vh"}} aria-busy="true" role="status">
         <Box sx={{display: "flex", flexDirection: "row"}}>
